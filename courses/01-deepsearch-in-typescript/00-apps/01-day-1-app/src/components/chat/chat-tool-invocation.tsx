...
export const ChatToolInvocation = ({ part }: ToolInvocationPartProps) => {
  ...
  return (
    <details
      className={cn(
        "group relative mb-4 rounded-lg border transition-all hover:shadow-md",
        isComplete
            ...
            <div className="flex items-center gap-2">
              ...
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs">
                  <p className="text-xs">
                    This is a tool call. Hover over different parts to explore
                    the data being passed to and from the tool.
                  </p>
                </TooltipContent>
              </Tooltip>
            </div>
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-1 text-xs font-medium text-gray-400">
            ...
            <Tooltip>
              ...
              <TooltipContent className="max-w-xs">
                <p className="text-xs">
                  These are the parameters sent to the tool.
                </p>
              </TooltipContent>
            </Tooltip>
          </div>
